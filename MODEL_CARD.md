...
- **Real images**: ~70,000 faces from Flickr-Faces-HQ (FFHQ) / CelebA
- **Fake images**: ~70,000 faces generated by StyleGAN
- **Resolution**: 256x256, resized to 299x299 for model input
...
- **Known limitations**:
  - Trained only on StyleGAN-generated faces — may not generalize to all deepfake generation methods (face-swap, reenactment, diffusion-based)
  ...
  - Optimized for frontal face images; performance may degrade on extreme poses or occlusions
